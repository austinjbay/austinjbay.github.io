...
I keep coming back to the [Fogg Behavior Model](https://www.behaviormodel.org/) because it is so easy to misuse in useful ways.
...
The [GOV.UK pattern for checking whether a service is suitable](https://design-system.service.gov.uk/patterns/check-a-service-is-suitable/) is useful because it starts with a simple respect for the user’s situation.
...
Another GOV.UK pattern I like here is [Start using a service](https://design-system.service.gov.uk/patterns/start-using-a-service/). It keeps coming back to an idea that sounds simple and turns out to be rare in product work.
