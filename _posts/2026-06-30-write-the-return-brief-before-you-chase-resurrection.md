...
Gloria Mark and her coauthors wrote in [No Task Left Behind? Examining the Nature of Fragmented Work](https://www.ics.uci.edu/~gmark/CHI2005.pdf) that interrupted work creates a cognitive cost to reorient to the task. That is workplace research, but I think the product lesson travels well. Returning users often pay a reorientation cost before they can do anything that counts as value.
...
Raluca Budiu wrote in [Memory Recognition and Recall in User Interfaces](https://www.nngroup.com/articles/recognition-and-recall/) that recognition is easier than recall because context cues help people retrieve what they need from memory. I think that is one of the most underused retention ideas in product work.
...
Practice, recency, and context all shape what will feel easy to recover. That is part of what makes [Memory Recognition and Recall in User Interfaces](https://www.nngroup.com/articles/recognition-and-recall/) so useful here. The user who touched the workflow yesterday has very different retrieval needs from the one who barely remembers why they opened the account.
