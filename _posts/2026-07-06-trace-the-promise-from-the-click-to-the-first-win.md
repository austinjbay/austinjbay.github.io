...
This is why I still like Adam Richardson's piece in [Harvard Business Review on customer journey maps](https://hbr.org/2010/11/using-customer-journey-maps-to). The useful reminder is not the diagram itself. It is the discipline of mapping the experience the user actually gets instead of the cleaner version each function imagines it shipped.
...
The [GOV.UK guidance on starting to use a service](https://design-system.service.gov.uk/patterns/start-using-a-service/) gets at this in a very practical way. Give users just enough information to understand what the service does, whether it meets their need, what it costs, how long it may take, and what they will need before they start.
...
The companion [GOV.UK pattern on checking whether a service is suitable](https://design-system.service.gov.uk/patterns/check-a-service-is-suitable/) pushes the same idea further. Help people work out early whether they can or should use the thing. That saves user time and also saves the team from processing avoidable confusion later.
...
Jakob Nielsen's [ten usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) are not growth writing, but they travel well.
